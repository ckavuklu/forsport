...
window.SearchManager = {
    ...
    search:function (searchString, successCallback, errorCallback) {
        var searchURL = this.apiUrl + "q=" + encodeURIComponent(searchString) + "&ll=" + window.GeoWatcher.position.latitude + "," + window.GeoWatcher.position.longitude + "&dist=100.00&d=" + new Date().getTime();
