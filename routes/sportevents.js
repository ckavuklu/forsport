...
exports.findAllSportEvents = function(req, res) {
	...
	console.log(nextDate);
        ...
        Event.find({eventDate : { $gt: nowDate, $lt: nextDate }}).populate('placeId', null, {loc: {$maxDistance: dist/111.2, $near: [lat,lon]} }).populate('hometeamId').populate('awayteamId').exec(function(err, pl) { 
	  console.log(pl);
	  res.send({events: pl});
	});
